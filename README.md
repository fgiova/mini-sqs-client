...
[![Maintainability](https://qlty.sh/gh/fgiova/projects/mini-sqs-client/maintainability.svg)](https://qlty.sh/gh/fgiova/projects/mini-sqs-client)
[![Code Coverage](https://qlty.sh/gh/fgiova/projects/mini-sqs-client/coverage.svg)](https://qlty.sh/gh/fgiova/projects/mini-sqs-client)
...
Are supported:
- sending messages (single and batch)
- receiving messages
- deleting messages (single and batch)
- changing message visibility (single and batch)
...
const result = await client.receiveMessage("arn:aws:sqs:eu-central-1:000000000000:test", {
	WaitTimeSeconds: 20,
...
await client.changeMessageVisibility(
	"arn:aws:sqs:eu-central-1:000000000000:test",
...
MiniSQSClient.sendMessageBatch(queueARN: string, messages: SendMessageBatchItem[]): Promise<SendMessageBatchResult>
...
MiniSQSClient.destroy(signer?: boolean): Promise<any[]>
```
